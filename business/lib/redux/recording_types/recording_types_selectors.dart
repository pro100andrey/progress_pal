...
import 'actions/retrieve_recording_types_action.dart';

/// Returns waiting value
bool selectRecordingTypesIsWaiting(AppState state) =>
    state.wait.isWaitingForType<RetrieveRecordingTypesAction>();
