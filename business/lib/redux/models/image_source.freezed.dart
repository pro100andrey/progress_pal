...
class NetworkImageSource implements ImageSource {
  const NetworkImageSource({required this.url});
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is NetworkImageSource&&(identical(other.url, url) || other.url == url));
}
