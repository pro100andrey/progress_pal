...
class LogsPageConnector extends StatelessWidget {
  const LogsPageConnector({super.key});

  @override
  Widget build(BuildContext context) => StoreConnector<AppState, _Vm>(
    debug: this,
    vm: () => _Factory(this),
    builder: (context, vm) => LogsPage(
...
class _Factory extends VmFactory<AppState, LogsPageConnector, _Vm> {
