...
mixin PBUpdateMixin<R extends RecordModel, B extends PBToJson>
    on PBCollection<R> {
...
mixin PBCreateMixin<R extends RecordModel, B extends PBToJson>
    on PBCollection<R> {
  /// Create a new record.
  Future<R> create({
    required B body,
...
mixin PBDeleteMixin<R extends RecordModel, B extends PBToJson>
    on PBCollection<R> {
  /// Delete a record.
  Future<void> delete(
    String id, {
...
mixin PBViewMixin<R extends RecordModel> on PBCollection<R> {
...
mixin PBListMixin<R extends RecordModel> on PBCollection<R> {
